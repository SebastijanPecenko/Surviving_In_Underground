 ...
 * @author pecen
 */
public class Main_easy extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Main_easy.class.getName());

    /**
     * Creates new form Main_lahko
     */
    private int x;
    private int y;
    private int speed = 5;
                ...
                if (jLabel4.getBounds().intersects(jLabel2.getBounds())) {
                    if (!vStikuSPajkom) {
                        ...
                        if (zivljenja <= 0) {
                            ...
                            dispose();
                            new End(tocke, preziveteSekunde, stopnja).setVisible(true);
                        }
                    }
                } else {
                    vStikuSPajkom = false;
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 310, 50, 30));
        ...
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 310, 50, 30));
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 220, 60, 120));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new Main_easy().setVisible(true));
    }

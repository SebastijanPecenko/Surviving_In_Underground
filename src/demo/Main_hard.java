 ...
 * @author pecen
 */
public class Main_hard extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Main_hard.class.getName());

    /**
     * Creates new form Main_tezko
     */
    private int x;
    private int y;
    private int speed = 5;
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new Main_hard().setVisible(true));
    }
